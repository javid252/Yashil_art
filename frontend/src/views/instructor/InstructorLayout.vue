<template>
  <div class="panel-shell">
    <aside class="panel-sidebar">
      <router-link to="/" class="panel-brand">🎨 یاشیل آرت <span>پنل استاد</span></router-link>
      <div class="panel-user">{{ userLabel }}</div>
      <nav class="panel-nav">
        <router-link to="/instructor/dashboard">📊 داشبورد</router-link>
        <router-link to="/instructor/courses">📚 دوره‌های من</router-link>
        <router-link to="/instructor/students">👥 دانشجویان</router-link>
        <router-link to="/instructor/attendance">📋 حضور و غیاب</router-link>
        <router-link to="/instructor/grades">📝 نمرات</router-link>
        <router-link to="/instructor/gallery">🖼️ گالری</router-link>
        <router-link to="/instructor/profile">👤 پروفایل</router-link>
      </nav>
