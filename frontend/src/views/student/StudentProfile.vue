    ...
    <div class="profile-card">
      <form @submit.prevent="saveProfile">
        ...
        <div class="form-group">
          ...
          <textarea v-model="form.bio" placeholder="درباره خودتان بنویسید..." rows="4"></textarea>
        </div>
...
<style scoped>
.student-profile h2 { margin-bottom: 16px; color: #1a2f1e; }
.profile-card {
...
.btn-save {
  padding: 10px 24px; background: #2d5a3f; color: #fff; border: none;
